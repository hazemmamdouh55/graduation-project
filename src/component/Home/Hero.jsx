...
function Hero() {
  ...
  return (
    <section className="relative w-full h-[90vh] flex flex-col justify-between overflow-hidden">
      <img src={heroImg} className="absolute w-full h-full object-cover" alt="hero-img" />
      <div className="absolute w-full h-full bg-black/45" />

      <div className="relative z-10 px-10 pt-16 text-white">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
          <h1 className="text-5xl font-bold text-white mb-9 tracking-tight">
            Ninja Teacher
          </h1>

          <div className="flex items-center gap-2 mb-4">
            <Sparkles className="text-yellow-400" size={18} />
            <span className="bg-gradient-to-r from-purple-500 via-blue-300 to-blue-500 text-white rounded-full px-3 py-1 text-sm font-medium">
              AI-Powered Teacher Matching Platform
            </span>
          </div>

          <h2 className="text-4xl font-bold leading-tight min-h-[100px]">
            {beforeTeaching}
          ...
          <p className="mt-4 text-gray-200 max-w-md text-base leading-relaxed">
