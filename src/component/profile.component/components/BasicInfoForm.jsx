...
export default function BasicInfoForm({ onNext, onBack }) {
  ...
  return (
    <div className="flex justify-center font-sans">
      ...
      >
        ...
        >
          <div className="w-28 h-28 rounded-2xl flex items-center justify-center relative
            bg-[linear-gradient(135deg,#F3E8FF,#DBEAFE)]
            border-[1.6px] border-[#9810FA] shadow-sm"
          >
