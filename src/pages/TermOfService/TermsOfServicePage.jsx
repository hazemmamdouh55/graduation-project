...
const sections = [
  {
    ...
    points: [
      ...
      "Teachers must provide accurate educational qualifications and certifications",
      "Schools must be legitimate educational institutions with proper authorization",
      "You are responsible for maintaining the confidentiality of your account credentials",
      "One account per user/institution is permitted",
  ...
  },
  {
    ...
    points: [
      "Use the platform for legitimate teacher-school matching purposes only",
      ...
      "Communicate professionally and courteously with all platform users",
      "Do not attempt to circumvent platform fees or payment systems",
      "Report any suspicious activity or policy violations to our team",
  ...
  },
  {
    ...
    points: [
      ...
      "Attempting to access or tamper with platform systems or other users' accounts",
  ...
  {
    icon: Bot,
    title: "Assessment & Matching Services",
    points: [
      "Assessment results are based on your responses and our proprietary algorithms",
      "Results are provided as guidance only and do not guarantee employment",
      "We do not verify the accuracy of user-provided information",
      "Match scores are calculated based on personality and competency compatibility",
      "Schools make final hiring decisions independently",
      "We are not responsible for the accuracy of job postings or school information",
      "Assessment data may be used to improve our algorithms (anonymized)",
    ],
  },
  {
    icon: Scale,
    ...
    points: [
      "All platform content, design, and algorithms are owned by ninja teacher",
      "You retain ownership of content you upload (profile information, documents)",
      "You grant us a license to use your content for platform operations",
      "Do not copy, reproduce, or distribute platform content without permission",
  ...
  },
  {
    ...
    points: [
      ...
      "We do not guarantee continuous, error-free, or secure platform operation",
      "We are not liable for employment decisions made by schools or teachers",
      "We do not conduct background checks or verify credentials (users' responsibility)",
      "We are not responsible for disputes between teachers and schools",
      "Maximum liability is limited to the amount paid for platform services",
  ...
  },
  {
    ...
    points: [
      ...
      "You are responsible for the security of your own devices and connections",
      "We may process data in accordance with applicable data protection laws",
      "You have rights regarding your personal data (see Privacy Policy)",
      "We may share data with third-party service providers under confidentiality agreements",
    ],
  },
];
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 pb-12">
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 mt-6 flex gap-3">
          <AlertTriangle className="text-amber-500 mt-0.5 flex-shrink-0" size={20} />
          <div>
            <p className="font-semibold text-black">Agreement to Terms</p>
            <p className="text-sm text-gray-600 mt-1">
              By accessing or using ninja teacher, you acknowledge that you have read, understood, and agree to
              be bound by these Terms of Service. If you do not agree to these terms, you may not use our
              platform.
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 space-y-5">
          {sections.map((s) => (
            <div key={s.title} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
              <div className="flex items-center gap-4 mb-5">
                <div className="w-14 h-14 bg-gradient-to-br from-purple-600 to-blue-500 text-white rounded-2xl flex items-center justify-center">
                  <s.icon size={26} />
                </div>
                <h2 className="font-bold text-2xl text-slate-900">{s.title}</h2>
              </div>
              <ul className="space-y-3">
                {s.points.map((p) => (
                  <li key={p} className="flex items-start gap-3 text-slate-700 text-sm">
                    <span className="mt-1.5 w-2.5 h-2.5 rounded-full bg-purple-600" />
                    {p}
                  </li>
                ))}
              </ul>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 w-full max-w-2xl mx-auto">
            <div className="flex items-center gap-4 mb-5">
              <h2 className="font-bold text-2xl text-slate-900">Termination & Suspension</h2>
            </div>
            ...
            <ul className="space-y-3 mb-4">
              {terminationReasons.map((r) => (
                <li key={r} className="flex items-start gap-3 text-slate-700 text-sm">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 w-full max-w-2xl mx-auto">
            <div className="flex items-center gap-4 mb-5">
              <h2 className="font-bold text-2xl text-slate-900">Changes to Terms</h2>
            </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 w-full max-w-2xl mx-auto">
            <div className="flex items-center gap-4 mb-5">
              <h2 className="font-bold text-2xl text-slate-900">Governing Law & Dispute Resolution</h2>
            </div>
            <div className="space-y-3 text-slate-700 text-sm">
