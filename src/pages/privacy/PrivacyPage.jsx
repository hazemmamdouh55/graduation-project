...
const sections = [
  {
    ...
    points: [
      ...
      "Educational background, qualifications, and certifications",
      "Assessment responses and personality trait data",
      "Employment history and professional references",
      "School information and institutional requirements",
      "Communication and messaging data within the platform",
  ...
  },
  {
    ...
    points: [
      "To match teachers with suitable schools based on personality and competency assessments",
      "To facilitate communication between teachers and schools",
      "To improve our matching algorithms and platform performance",
      "To send relevant job recommendations and platform updates",
      "To verify credentials and maintain platform integrity",
  ...
  },
  {
    ...
    points: [
      ...
      "Secure databases with access controls and regular security audits",
      "Regular backups to prevent data loss",
      "Limited employee access on a need-to-know basis only",
  ...
  },
  {
    ...
    points: [
      "We share your profile with schools only when you apply for positions or express interest",
      "Assessment results are shown to schools as match scores, not raw data",
      "We never sell your personal information to third parties",
      "Limited data sharing with trusted service providers under strict confidentiality agreements",
      "Legal disclosures only when required by law or to protect rights and safety",
      "You have full control over profile visibility settings",
    ],
  },
  {
    icon: UserCheck,
  ...
  },
  {
    ...
    points: [
      ...
      "Legal obligations: Some data retained longer to comply with legal requirements",
      "Assessment results: Anonymized data may be retained for research purposes",
      "Communication logs: Retained for dispute resolution and platform improvement",
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800">
      ...
      <main className="max-w-3xl mx-auto px-3 sm:px-4 pb-10">
        <div className="mt-8 border-l-4 border-blue-400 bg-blue-50 p-5 rounded-r-xl">
          <div className="flex items-center gap-2 mb-2">
            <Info size={18} className="text-blue-500" />
            <p className="font-bold text-slate-900 text-sm">Important Notice</p>
          </div>
        ...
        <div className="mt-6 space-y-5">
          {sections.map((s) => (
            <div key={s.title} className="bg-white p-5 rounded-xl shadow-sm border border-slate-100">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="font-bold text-xl text-slate-900">{s.title}</h2>
              </div>
        ...
        <div className="mt-5 bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            <Cookie size={18} className="text-purple-600" />
            <h3 className="font-bold text-xl text-slate-900">Cookies & Tracking Technologies</h3>
          </div>
          <ul className="space-y-2.5">
            {cookieTypes.map((c) => (
              <li key={c.label} className="flex items-start gap-2 text-sm text-slate-700">
                <CheckCircle2 size={16} className="text-green-500 mt-0.5" />
                <span>
                  <span className="font-semibold">{c.label}</span> {c.desc}
                </span>
              </li>
            ))}
          </ul>
        ...
        <div className="mt-6 bg-gradient-to-r from-purple-600 to-blue-500 text-white text-center p-7 rounded-2xl">
          ...
          <div className="mt-4 flex flex-col sm:flex-row justify-center gap-3">
            ...
            href="mailto:legal@ninjateacher.com"
